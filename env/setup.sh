...
wp import "{$root}/env/themes-pages.xml" --authors=create
wp import "{$root}/env/themes-repopackages.xml" --authors=create
wp import "{$root}/env/themes-theme_shops.xml" --authors=create
